...
import {pendingData} from '../../util/clientJob/pendingJobData';
     ...
     <View style={styles.listContainer} key={val.id}>
         ...
         <Image source={val.img} style={{height:70, width:70,alignItems:'center', borderRadius:50, }}/>
           ...
           <View style={styles.listContent}>
               ...
               <View style={{flexDirection:'row', width:290,justifyContent:'space-evenly', alignItems:'center'}}>
                   <View style={{flexDirection:'row',width:150,justifyContent:'flex-start', marginLeft:38,}}>
     ...
     <Modal
      ...
      <Modal
         ...
         onRequestClose = {() =>{ console.log("Modal has been closed.") } }>
             ...
             <Image source={require('../../assets/success_1.png')} style={styles.smileImg} />

             </View>


                     <View style={{alignItems:'center', flexDirection:'column'}}>
                          <Text style={{fontSize:20 , color:'#34B44B',margin:3,textAlign:'center',fontWeight:'bold'}}>Congratulations!!!</Text>
                          <Text style={{fontSize:13, fontWeight:'bold',color:'gray',margin:3, textAlign:'center'}}> Fund will be Released Within 12 - 24 hours.</Text>
                          <Text style={{fontSize:13, fontWeight:'bold', color:'gray',margin:3,textAlign:'center'}}>Upon Confirmation By Service Consumer.</Text>
                     </View>
       ...
       <Modal
          ...
          onRequestClose = {() =>{ console.log("Modal has been closed.") } }>
              ...
              <View><Text style={styles.Te}> Pending Job</Text></View>
                 ...
                 <View style={{ flexDirection:'row', position:'absolute',top:390,width:320, alignItems:'center', justifyContent:'center'}}><Text  style={styles.blink}>Status:Job In Progress</Text></View>
