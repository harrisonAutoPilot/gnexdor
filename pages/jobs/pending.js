      ...
      <Modal
       ...
       <Modal
          ...
          <View style={styles.btnContainer}>
              ...
              <Text style={{color:'#747474', fontSize:13,}}>COMPLETE REQUEST</Text>
              </TouchableOpacity>
              </View>
              <View style={styles.otherServiceBtn}>
              <TouchableOpacity style={styles.bckBtn}  onPress = {() => {
                  this.props.navigation.navigate('Profile_Activity_Short')}}>
              <Text style={{color:'#747474', fontSize:9.5,}}>TERMINATE REQUEST</Text>
              </TouchableOpacity>
              <TouchableOpacity style={styles.bckBtn} onPress = {() => {
                          this.setState({ isVisibleRequest:!this.state.isVisibleRequest})}}>
              <Text style={{color:'#747474', fontSize:9.5,}}>GO BACK</Text>
              </TouchableOpacity>
              </View>
