               ...
               data && data.length > 0 && data.map(val => {
                return (
                 ...
                 <View style={styles.serviceDiv}>
                  <View style={{ flexDirection:'row', width:170}}><Text style={{fontSize:11, color:'gray',marginLeft:2}}> {val.serviceName}</Text></View>
         ...
         onRequestClose = {() =>{ console.log("Modal has been closed.") } }>
             ...
             <Image source={require('../../assets/success_1.png')} style={styles.smileImg} />
                     ...
                     <View style={{alignItems:'center', flexDirection:'column'}}>
                          <Text style={{fontSize:18 , color:'#34B44B',margin:3,fontWeight:'bold'}}>Congratulations!!!</Text>
                          <Text style={{fontSize:13, fontWeight:'bold',color:'gray',margin:3}}>Kindly ensure that you Deliver / Complete</Text>
                          <Text style={{fontSize:13, fontWeight:'bold', color:'gray',margin:3}}>On or Before: 20/05/2020</Text>
                     </View>
              ...
              <View><Text style={styles.Te}>Job Request</Text></View>
                ...
                <View style={styles.btnContainerReq}>
                    ...
                    <TouchableOpacity style={styles.bckBtn} onPress = {() => this.RBSheet.open()}>
                     <Text style={{fontSize:12,color:'gray' }}>REJECT</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.bckBtn} onPress = {() => {
                         this.setState({ isVisibleService:!this.state.isVisibleService})}}>
                  <Text style={{fontSize:12,color:'gray' }}>ACCEPT</Text>
                    </TouchableOpacity>
