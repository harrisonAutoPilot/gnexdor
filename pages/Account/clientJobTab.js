...
import Request from '../clientJobs/request';
import Pending from '../clientJobs/pending'
import Completed from '../clientJobs/completed'
...
//
const ClientJobTab = createAppContainer(TabScreen);

export default ClientJobTab;
//
