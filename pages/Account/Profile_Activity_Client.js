     ...
     const ratingObj = {
      ...
      return (
        ...
        <View style={styles.MainContainer}>
                     ...
                     <View style={{height:hp('7%'), width:wp('45%'), justifyContent:'center', alignItems: 'center', left:wp('5%'), flexDirection:'column'}}>
                     ...
                     <View style={{flexDirection:'column', alignItems:'center'}}>
                       ...
                       <TouchableOpacity style={styles.jobs} onPress={() => this.props.navigation.navigate('ClientJob')}>

                      <Image  source={require('../../assets/work.png')} style={{width:15, height:15,}} />
