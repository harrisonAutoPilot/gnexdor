...
class Loading extends Component{
 ...
 render(){
  ...
  return(
      ...
      <View style={{position:'absolute',width:wp('85%'), height:hp('20%'),top:hp('50%'), justifyContent:'center', alignItems:'center', zIndex:9, textAlign:'center',}}>
           <BlinkingText text='Welcome Loading and Configuring Profile...' />
